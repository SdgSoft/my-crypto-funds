...
export const routes: Routes = [
  ...
  { path: 'assets/detail/:id', component: AssetDetailPage},
  ...
  { path: 'chains/detail/:id', component: ChainDetailPage},
  ...
  { path: 'coins/detail/:id', component: CoinDetailPage},
  ...
  { path: 'wallets/detail/:id', component: WalletDetailPage},
