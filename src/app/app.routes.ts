...
export const routes: Routes = [
  ...
  { path: 'asset', component: AssetNewPage, pathMatch: 'full' },
  { path: 'asset/:id', component: AssetEditPage},
  { path: 'chains', component: ChainsPage , pathMatch: 'full' },
  { path: 'chains/:id', component: ChainDetailPage},
  { path: 'chain', component: ChainNewPage, pathMatch: 'full' },
  { path: 'chain/:id', component: ChainEditPage},
  { path: 'coins', component: CoinsPage , pathMatch: 'full' },
  { path: 'coins/:id', component: CoinDetailPage},
  { path: 'coin', component: CoinNewPage, pathMatch: 'full' },
  { path: 'coin/:id', component: CoinEditPage},
  { path: 'wallets', component: WalletsPage , pathMatch: 'full' },
  { path: 'wallets/:id', component: WalletDetailPage},
  { path: 'wallet', component: WalletNewPage, pathMatch: 'full' },
  { path: 'wallet/:id', component: WalletEditPage},
];
